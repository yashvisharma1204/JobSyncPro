...
def cache_resume(parsed_resume, cache_key, cache_folder='Cache/'):
...
def load_cached_resume(cache_key, cache_folder='Cache/'):
...
def cache_gemini_response(gemini_response, cache_key, cache_folder='Cache/'):
...
def load_cached_gemini_response(cache_key, cache_folder='Cache/'):
